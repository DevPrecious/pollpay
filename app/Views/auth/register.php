...
<div class="py-6 px-6">
    <div class="flex justify-center md:p-4 p-6 md:max-w-md max-w-lg mx-auto bg-white rounded-xl shadow-md flex items-center space-x-4">
        <div class="py-4 px-4 flex flex-col">
            ...
            <span class="pt-2 font-light text-lg md:flex md:justify-center">Already have an account?
            ...
            <form action="" method="POST" class="">
                ...
                <div class="md:flex md:flex-row">
                    <div class="pt-6">
                        <input type="text" name="firstname" value="<?= set_value('firstname') ?>" class="rounded-lg p-4 ring ring-gray-100 ring-offset-0 w-full h-8 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="First Name" />
                    </div>
                    <div class="pt-6 md:pl-2">
                        <input type="text" name="lastname" value="<?= set_value('lastname') ?>" class="rounded-lg p-4 ring ring-gray-100 ring-offset-0 w-full h-8 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Last Name" />
                    </div>
                </div>
                <div class="pt-6">
